...
if (!empty($_POST['postid'])) {
	...
	if (!empty($assetdata)) {
		...
		$parenthtml.='<div id="poll" class="create_poll1" >
						<div>
							<form method="post" enctype="multipart/form-data" action="http://purpledot.co/works/streetbuzz/plugin/poll/admin?action=users&amp;poll_id=0&amp;from=users">
								<div>
...
$imagedes .= '<a target="_blank" href="'.($C->STORAGE_URL.'tmp/'.$tmp->file_preview).'" class="lightbox-image image-thumb cboxElement"><img width="100%" alt="Image" src="'.$C->STORAGE_URL.'tmp/'.($tmp->file_preview).'" /></a>';



}
$input_file .= '<input type="file" name="file" class="btn btn-xs btn-white active" id="file" value="">';
...
$editfunction;
if(empty($eventdetails)&&empty($poll))$editfunction='<button id="edittext" onclick="edittext('.$postid.','.$postid.')" type="button" class="btn  blue center">Edit</button>';
elseif(empty($eventdetails))$editfunction='<button id="editpoll" onclick="editpoll('.$postid.','.$postid.',poll)" type="button" class="btn  blue center">Edit</button>';
	...
	<div class="modal-dialog" id="graph-chat">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
								...
								<div class="col-lg-11 col-md-11 col-sm-11 col-xs-10" style="padding:0px 3px 0px 8px;">
									<div class="activity-container">
										<div class="activity-header col-lg-12 col-md-12 col-sm-12 col-xs-12"><a href="<?php echo userlink($result->username); ?>" class="author bizcard" data-userid="<?php echo userlink($result->user_id); ?>"><?php echo ($result->username); ?></a>
											<!-- change6 -->
				...
				<div style="padding:8px;background-color: #0084B4;
    background: rgba(0, 132, 180, .1);">
					<?php echo (empty($eventdetails)&&empty($poll))?
				...
				<!-- change7 -->
				<div class="textarea-wrap comment" style="height:150px;">
							<!-- change3 -->
							<textarea class="editpostreplay" id="message-'.$postid.'" name="message"  style="overflow:auto; height:150px">'.$result->message.' </textarea>
							<!-- <textarea class="editpostreplay" id="message-<?php //echo $postid; ?>" name="message">'.$result->username.'</textarea> -->
						</div>
						<!-- change4 -->
						<!-- <div id="editpoll">
						<?php //echo $parenthtml; ?>							
...
<!-- change 4 ends -->
					</div>' : '<div class="activity-content">'.$parenthtml.'</div>';
					?>
									...
									<div class="row">
										...
										<div class="col-md-8" style="padding:0">
											<div class="col-md-12" style="padding:0">
												...
												<div class="col-md-11" style="padding:0">
													<span class="add-more"><strong>Question</strong></span> <br>
													<input type="text" class="form-control title" id="question-<?php echo $postid;  ?>" name="question" value="">
