...
window.webcam = {
	...
	swf_url: 'http://streetbuzz.co.in/newsapp/static/images/webcam.swf', // URI to webcam.swf movie (defaults to cwd)
	shutter_url: 'http://streetbuzz.co.in/newsapp/static/images/shutter.mp3', // URI to shutter.mp3 sound
	...
	get_html: function(width, height, server_width, server_height) {
		...
		if (!server_width) server_width = 50;
		if (!server_height) server_height = 50;
	...
	set_shutter_sound: function(enabled, url) {
		...
		this.shutter_url = url ? url : 'http://streetbuzz.co.in/newsapp/static/images/shutter.mp3';
	},
