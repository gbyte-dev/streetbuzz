...
var Htmlareaassetpredict = function () {
            ...
            if (e.which != 37 && e.which != 38 && e.which != 39 && e.which != 40) { // do not make ajax calls on arrow key press
                setTimeout(function () {
                    ...
                    var args = {
        					...
        					module: 'users',
        					action: 'autocomplete',
        					data: { users_name: cnt,usertype:usertype,finaldata:text}
        				}
    ...
    return {
        init: function (el) {
            htmlAreaEl = ($(el).length > 0) ? $(el) : $('#predict_search');
...
$(document).ready(function () {
    ...
    //Htmlarea.init();
    Htmlareaassetpredict.init($('#predict_search'));
