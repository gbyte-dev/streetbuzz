...
var hastxtedit = function () {
    ...
    function startAC(grouptxtEl) {
        ...
        accontainer = $('.htmlarea-ac-container1');
        searchString = '';
        //var char = '';
    ...
    function stopAC() {
        ...
        $('#hastagedit').unbind('keydown.ac');
        $('.htmlarea-ac-container1').hide();
    }
    ...
    function highlighter(el) {
        ...
        if ($(el).parents('#hastagedit').length > 0) {
            $(el).parents('#hastagedit').find('.textarea-highlighter').html(cnt);
        } else {
                ...
                */
                ...
                if (e.which == 13) { // stop autocomplete 
                    if (e.which == 13 && autocompleteActive) {
                        ...
                        selected = $('li.selection', '.htmlarea-ac-container1');
 ...
 $("#hastagedit").keyup(function(){

    hastxtedit.init($('#hastagedit'));
