...
<div class="col-md-6 col-lg-8 signin-page">

	<h1 class="pagetitle pd-2"><?= $this->page->lang('signin_form_caption') ?></h1>

	<form action="" method="post">
	
	
		<label for="email"><?= $this->page->lang('signin_email_or_username') ?></label>
		<input type="text" class="text form-control" id="email" name="email" data-status="focus">
		<div class="clear"></div>
		
		<label for="password"><?= $this->page->lang('signin_form_password') ?></label>
		<input type="password" class="text form-control" id="password" name="password">
		
		
	
		<div class="registration-buttons">
			<button type="submit" class="btn btn-lg btn-primary"><span><?= $this->page->lang('signin_login_box_ttl') ?></span></button>
