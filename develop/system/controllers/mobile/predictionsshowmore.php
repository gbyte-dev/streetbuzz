...
<a href="'.userlink($allpredictval->username).'" class="avatar bizcard" data-userid="'.$allpredictval->user_id.'"><img src="'.$src.'"  /></a>	
	...
	<div class="activity-footer meta-info">
				...
				<a style="cursor:pointer" onclick="activityAddCommentchield('.$allpredictval->post_id.')"><img class="icons" src="'.$C->SITE_URL.'static/images/icons/REPLY.png" title="Reply"></a>
			...
			<div class="dropdown">
				...
				<div class="comment-chield" style="display:none" id="chield'.$allpredictval->post_id.'">
				<div class="comments-editor data-content-placeholder" data-token="069fc5555">
				<div>
				
				<div class="activity-header commentpost'.$allpredictval->post_id.'">
				<a href="'.$C->SITE_URL.''.$allpredictval->username.'" class="author bizcard" data-userid="'.$allpredictval->user_id.'">'.$allpredictval->username.'</a>
...
<a href="'.userlink($mypeopllepredictval->username).'" class="avatar bizcard" data-userid="'.$mypeopllepredictval->user_id.'"><img src="'.$src.'"  /></a>	
	...
	<div class="activity-footer meta-info">
				...
				<a style="cursor:pointer" onclick="activityAddCommentchield('.$mypeopllepredictval->post_id.')"><img class="icons" src="'.$C->SITE_URL.'static/images/icons/REPLY.png" title="Reply"></a>
...
<a href="'.userlink($allclosedval->username).'" class="avatar bizcard" data-userid="'.$allclosedval->user_id.'"><img src="'.$src.'"  /></a>	
	...
	<div class="activity-footer meta-info">
				...
				<a style="cursor:pointer" onclick="activityAddCommentchield('.$allclosedval->post_id.')"><img class="icons" src="'.$C->SITE_URL.'static/images/icons/REPLY.png" title="Reply"></a>
			...
			<div class="dropdown">
				...
				<div class="comment-chield" style="display:none" id="chield'.$allclosedval->post_id.'">
				<div class="comments-editor data-content-placeholder" data-token="069fc5555">
				<div>
				
				<div class="activity-header commentpost'.$allclosedval->post_id.'">
				<a href="'.$C->SITE_URL.''.$allclosedval->username.'" class="author bizcard" data-userid="'.$allclosedval->user_id.'">'.$allclosedval->username.'</a>
