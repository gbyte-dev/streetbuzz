...
<div style="position: relative; text-align:right;" class="crs cross<?php echo$marketid; ?>">
...
<input type="hidden" class="singledata<?php echo $marketid; ?>" value="">
<input type="text" class="assets" value="<?php echo $marketid; ?>">
...
;(function ($, document, window, navigator, undefined) {
    ...
    var double_html =
        ...
        '<span class="irs-slider from">S</span>' +
        '<span class="irs-slider to">T</span>';
    ...
    var IonRangeSlider = function (input, options, plugin_count) {
        ...
        config_from_data = {
            ...
            to: $inp.data("to"),
            step: $inp.data("step"),
			ordertype: $inp.data("ordertype"),
			assettype: $inp.data("assettype"),
			currnt: $inp.data("currnt"),
    ...
    IonRangeSlider.prototype = {
        ...
        append: function () {
            ...
            this.$cache.single = this.$cache.cont.find(".irs-single");
			 this.$cache.linesingle = this.$cache.cont.find(".irs-line-left");
        ...
        drawHandles: function () {
            ...
            if (this.old_from !== this.result.from || this.old_to !== this.result.to || this.force_redraw || this.is_key) {
                ...
                if (this.options.type === "single") {
					...
					var singledata = $(".singledata"+this.options.ordertype).val();
					if(singledata ==''){
						$(".singledata"+this.options.ordertype).val(this.labels.p_single_left);

					}
                    var singleleft = $(".singledata"+this.options.ordertype).val();
                    this.$cache.single[0].style.left = singleleft + "%";
				...
				var left = parseInt((this.coords.p_from_fake).toFixed(2))+parseInt((this.coords.p_to_fake).toFixed(2));
				var left        =(left/2);
				$("#left").val(left);
				$("#left2").val(left);
        ...
        drawLabels: function () {
            ...
            if (this.options.type === "single") {
                ...
                if (values_num) {
					...
					// this.options.currnt
					var netprice        = this.options.currnt;
					var sliderval = (text_from)+','+netprice+','+(text_to);
			        $(".assetdata"+this.options.ordertype).val(sliderval);
					
					this.$cache.single.html('<div style="margin-top:40px;">'+this.options.currnt+this.options.assettype+'</div>');
                    this.$cache.from.html(text_from);
                    this.$cache.to.html(text_to);
            ...
            for (i = 0; i < big_num + 1; i++) {
                ...
                for (z = 1; z <= local_small_max; z++) {
                   ...
                   // html += '<span class="irs-grid-pol small" style="left: ' + small_w + '%"></span>';
					//html += '<span class="irs-grid-pol small" style="left:'+left+'%">(Netprice)</span>';
                }
                ...
                html += '<span class="irs-grid-text js-grid-text-' + i + '" style="left: ' + big_w + '%"></span>';
