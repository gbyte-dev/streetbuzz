      ...
      <div class="modal-body">
		  ...
		  $eventdetails = $buff->geteventdetails($result->id);
				...
				if(!empty($assetdata)){
					...
					$url = $C->SITE_URL;
				$parentmessage = $buff->notificationeventhtml($result->id,$url);
			   }elseif(!empty($poll)){
				  $url = $C->SITE_URL;
				  
				 
				$parentmessage =$buff->notificationpollhtml($result->id,$url,$eventtype);
	  ...
	  $chi ='';
		...
		$date = str_replace(array_keys($tmp), array_values($tmp), $txt);
		  $is_reshared    =$buff->is_post_reshared($result->id);
			...
			$like = '<div class="like-list"><a href="" data-role="services" data-namespace="activities" data-action="'.($is_liked? 'unlike' : 'like').'" data-value="'.htmlentities('{"activities_type":"public","activities_id":"'.$result->id.'"}').'">'.($is_liked? '<img  src="'.$C->SITE_URL.'static/images/icons/LIKE.png"  title="Like"/>' : '<img class="icons" src="'.$C->SITE_URL.'static/images/icons/LIKE.png"  title="Like"/>').'</a>'.$showlikes_btn.'</div>';
                    $agree ='<div class="agree-list"><a href="" data-role="services" data-namespace="activities" data-action="'.($is_agree? 'disagree' : 'agree').'" data-value="'.htmlentities('{"activities_type":"public","activities_id":"'.$result->id.'"}').'">'.($is_agree? '<img  width="30px" src="'.$C->SITE_URL.'static/images/icons/a2d.png"  title="Disagree"/>' : '<img width="30px" class="icons" src="'.$C->SITE_URL.'static/images/icons/a2d.png"  title="Agree"/>').'</a>'.$showagreebtn_btn.'</div>';
					...
					$resharesocial = '<div class="dropdown">
							   ...
							   <ul class="menu-options">
								  ...
								  <li><a href="http://www.stumbleupon.com/submit?url='.urlencode($C->SITE_URL.'/view/post:'.$parentid).'  target="_blank" >StumbleUpon</a></li>
								  <li><a href="http://www.myspace.com/Modules/PostTo/Pages/?u='.urlencode($C->SITE_URL.'/view/post:'.$parentid).'  target="_blank" >MySpace</a></li>
								  <li><a href="http://friendfeed.com/?url='.urlencode($C->SITE_URL.'/view/post:'.$parentid).'&title='.urlencode(htmlspecialchars($row->message)).'  target="_blank" >FriendFeed</a></li>
		  ...
		  ?>
            ...
            <div class="activity no-comments commentcontainer " id="<?php echo $main;?>" style="border:0px solid #E1E8ED;" >
               <!-- start Parent -->
			   ...
			   ?>
                   ...
                   <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                     ...
                     <a href="<?php echo userlink($result->username); ?>" class="avatar bizcard" data-userid="<?php echo userlink($result->user_id); ?>"><img src="<?php echo getAvatarUrl($result->avatar, 'thumbs1')?>" alt="<?php echo $result->username?>" /></a>
                     </div>
					 <div>
					 </div>
                     ...
                     <div class="col-lg-11 col-md-11 col-sm-11 col-xs-10" style="padding:0px 3px 0px 8px;">
                       ...
                       <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                         <div class="activity-footer meta-info col-lg-12 col-md-12 col-sm-12 col-xs-12">
                              <i class="fa fa-clock-o">&nbsp;&nbsp;</i><a href="<?php echo $C->SITE_URL?>/view/post:<?php echo $postid ;?>" class="permlink"><?php echo $date; ?></a>
    ...
    background: rgba(0, 132, 180, .1);">
         <div class="user-status-field htmlarea userreplaybuzz " style ="height:auto;">
            ...
            <div class="textarea-wrap comment">
               <textarea class="editpostreplay" id="message-<?php echo $childid; ?>" name="message">@<?php echo $replayuser->username;?> </textarea>
            </div>
         </div>
...
<span data-value="999" class="post-cal">999</span> 
	...
	<button style="display:none;" onclick="commentevent(<?php echo $postid; ?>,<?php echo $childid; ?>,<?php echo $eventtype;?>)" type="button" id="<?php echo $postid; ?>" class="eventpost comment-post comment-post post-btn btn  blue center">Buzz</button>

		
 <button  style="display:none;"  onclick="commentpoll(<?php echo $postid; ?>,<?php echo $childid; ?>,<?php echo $eventtype;?>)" type="button" id="<?php echo $postid; ?>" class="pollpost comment-post comment-post post-btn btn  blue center">Buzz</button>
		
	  <button  style="display:none;"  onclick="commentintraday(<?php echo $postid; ?>,<?php echo $childid; ?>,<?php echo $eventtype;?>)" type="button" id="<?php echo $postid; ?>" class="intrapost comment-post comment-post post-btn btn  blue center">Buzz</button>

<button  disabled="disabled" onclick="comment(<?php echo $postid; ?>,<?php echo $childid; ?>,<?php echo $eventtype;?>)" type="button" id="<?php echo $postid; ?>" class="buzzpost comment-post  post-btn btn  blue center">Buzz</button>
		</div>
		 </div>
      </div>
   </div>
...
<script type="text/javascript">
  ...
  //var main = $(".start<?php echo $eventtype;?><?php echo $postid;?>").height();
// $(".janeeshchild<?php echo $postid;?>").css("height",main); 
   running = true;
        var end = setInterval(function () {
			...
			var main = $("#main<?php echo $childid;?>").height();
			$(".janeeshchild<?php echo $postid;?>").css("height",main); 
