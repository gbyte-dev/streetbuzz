<?php
	...
	(
		...
		(
			...
			'embed_w'		=> 460,
			'embed_h'		=> 288,
			'embed_code'	=> '<object width="100%" height="288"><param name="movie" value="https://www.youtube.com/v/###ID###&hl=en&rel=0&color1=0x006699&color2=0x54abd6" /><param name="wmode" value="opaque" /><embed src="https://www.youtube.com/v/###ID###&hl=en&rel=0&color1=0x006699&color2=0x54abd6" type="application/x-shockwave-flash" width="460" height="288" wmode="opaque"></embed></object>',
			'embed_thumb'	=> 'https://i.ytimg.com/vi/###ID###/default.jpg',
			'embed_thumb_orig' => 'https://img.youtube.com/vi/###ID###/mqdefault.jpg',
			'insite_url'	=> 'https://youtube.com/watch?v=###ID###',
		),
		...
		(
			...
			'embed_code'	=> '<embed src="https://www.youtube.com/v/###ID###&autoplay=1&rel=0&fs=1" type="application/x-shockwave-flash" allowscriptaccess="never" enableJavascript ="false" allowfullscreen="true" width="100%" height="100%" wmode="transparent"></embed>',
			'embed_thumb'	=> 'https://i.ytimg.com/vi/###ID###/default.jpg',
			'embed_thumb_orig' => 'https://img.youtube.com/vi/###ID###/mqdefault.jpg',
			'insite_url'	=> 'https://youtube.com/watch?v=###ID###',
		),
		...
		'vine' => (object) array
		(
			'src_url_pattern'		=> '/^http(s)?\:\/\/(www\.)?(vine\.co)\/v\/([a-z0-9-]{3,})/i',
			'src_url_matchnum'	=> 4,
			'src_emb_pattern'		=> '/^http(s)?\:\/\/(www\.)?(vine\.co)\/v\/([a-z0-9-]{3,})\/embed/i',
			'src_emb_matchnum'	=> 2,
			'embed_w'		=> 295,
			'embed_h'		=> 295,
			'embed_code'	=> '<iframe class="vine-embed" src="https://vine.co/v/###ID###/embed/simple" width="295" height="295" frameborder="0"></iframe><script async src="//platform.vine.co/static/scripts/embed.js" charset="utf-8"></script>',
			'embed_thumb'	=> $C->SITE_URL.'static/images/vine-logo.png',//does not found any information about this
			'insite_url'	=> 'https://vine.co/v/###ID###',
		)
