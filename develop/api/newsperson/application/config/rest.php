...
$config['auth_override_class_method']['search']['index']            = 'none';
$config['auth_override_class_method']['search']['trending_tags']            = 'none';
$config['auth_override_class_method']['search']['all']            = 'none';
$config['auth_override_class_method']['search']['poll']            = 'none';
$config['auth_override_class_method']['search']['events']            = 'none';
$config['auth_override_class_method']['search']['news']            = 'none';
$config['auth_override_class_method']['search']['profile']            = 'none';
$config['auth_override_class_method']['post']['guest_timeline']             = 'none';
$config['auth_override_class_method']['post']['poll_near_you']              = 'none';
$config['auth_override_class_method']['post']['event_near_you']             = 'none';
$config['auth_override_class_method']['post']['get_post_type']             = 'none';
$config['auth_override_class_method']['search']['locationtrending_tags']    = 'none';

$config['auth_override_class_method']['user']['top_news_persons']           = 'none';
$config['auth_override_class_method']['user']['reset_password']           = 'none';
$config['auth_override_class_method']['user']['social_login']           = 'none';
$config['auth_override_class_method']['user']['get_reporter_pending_payment']           = 'none';
$config['auth_override_class_method']['user']['get_reporter_pending_payment']           = 'none';

$config['auth_override_class_method']['search']['index']  = 'none';
$config['auth_override_class_method']['search']['coverage_location']  = 'none';
$config['auth_override_class_method']['search']['coverage_category']  = 'none';

$config['auth_override_class_method']['location']['*'] = 'none';

$config['auth_override_class_method']['forgot_password']['*']           = 'none';
$config['auth_override_class_method']['register']['index']    = 'none';

$config['auth_override_class_method']['register']['signup']    = 'none';
$config['auth_override_class_method']['register']['check_username']    = 'none';
$config['auth_override_class_method']['register']['check_email']    = 'none';
$config['auth_override_class_method']['register']['check_mobile']    = 'none';
$config['auth_override_class_method']['register']['suspend']    = 'none';
$config['auth_override_class_method']['register']['resume']    = 'none';
...
|
*/
$config['rest_keys_table'] = 'oauth_access_token';
