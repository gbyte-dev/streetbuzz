<?php
	class services
	{
		...
		public function load()
		{
			...
			if(!empty($_SESSION['ajax_html'])){
			    	$html_result  = $_SESSION['ajax_html'];
			 }


			$this->ajax_data['data'] = array();
			$this->ajax_data['data']['html'] = $html_result;
			if(!empty($_SESSION['last_activity_id'])){
			      $this->ajax_data['data']['last_activities_id'] = $_SESSION['last_activity_id'];
			 }
			...
			unset($_SESSION['last_activity_id']);
