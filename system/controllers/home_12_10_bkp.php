...
<li class="toc-entry toc-h2"><a href="<?php echo $C->SITE_URL?>principles/index.html">Principles</a>
</li>
<li class="toc-entry toc-h2"><a href="<?php echo $C->SITE_URL?>privacy-terms-rules/about/index.html">About Us</a>
</li>
...
<ul>
          ...
          <?php
            ...
            left join posts_attachments as pa ON pa.post_id=p.id WHERE h.main_or_not ="'.$yes.'" group by p.id order by h.sequence asc');
        ...
        <main class="col-12 col-md-9 col-xl-6 py-md-3 bd-content" role="main"  style="border-right: 1px groove #00000052;
                    border-left: 1px groove #00000052;">
...
?>
<br>
<h4>Trending in <?php echo $_GET['name']; ?></h4>
...
?>
  ...
  <div class="modal" id="myModal">
    ...
    <div class="form-group">
      ...
      <span style="color:red;" id="error_useremail"></span>
    </div>
    ...
    <div class="form-group">
      <input type="password" class="form-control" id="userpassword" placeholder="Password" >
            <span style="color:red;" id="error_passd"></span>
...
<div class="bd-example newsrow card"> 
<div class="row">
    <?php 
    ...
    if(!empty($result->avatar)){
      $avatar=$C->STORAGE_URL.'avatars/thumbs3/'.$result->avatar;
        ...
        $avatar=$C->SITE_URL.'storage/avatars/thumbs3/_noavatar_user.gif';   
    }
    
    ?>

<div class="col-sm-6" style="background:none;border:none;width:60%;"><div style="background:none;border:none;float:left"><img style="height:50px;width:50px;border-radius:50%" src="<?= $avatar ?>"></div><div style="background:none;border:none;float:left;padding-left: 10px;">
...
<div class="col-sm-6" style="width:40%;text-align: end;background:none;border:none;"><button class="btn btn-primary"><a style="text-decoration:none;color:white" href="<?= $C->SITE_URL ?><?php echo $result->username;?>"><i class="fa fa-plus"></i>Follow</a></button><br>
...
foreach ($imgTags as $imgTag) {
    $src = $imgTag->getAttribute('src');
     $image=$src; // This will output the src attribute value
      ...
      <img   style="width:100%"  style="border-radius:11px;"  alt="Image" src="<?php echo $image;?>">
      <?php }else{ 
           $thumbimg = $C->SITE_URL.'storage/avatars/thumbs3/_noavatar_user.gif';
      ?>
...
$video = $data_attachment[0]->video_url; 
...
$("#fullname").keyup(function(){
  ...
  $("#sub").click(function(){
    ...
    if(full =="" || email =="" || userpassword =="" || username ==''){
        
    if(full ==""){
      $("#fullname").css("border-color","red");
      $("#error_fname").text("This is required field.");
    ...
    if(email ==""){
     ...
     $("#error_useremail").text("This is required field.");
    }else{
    ...
    if(userpassword ==""){
     ...
     $("#error_passd").text("This is required field.");
    }else{
        $("#error_passd").text(" ");
    }
    if(username ==''){
      $("#username").css("border-color","red");
     $("#error_userId").text("This is required field.");
  ...
  {  
    ...
    if( full !='' && email !='' && username !=''){
     ...
     $.ajax({
      ...
      type:"POST",
      data:{fullname:full,strret_useremail:email,street_username:username,street_userpassword:userpassword,profile_birth_day:day,profile_birth_month:month,profile_birth_year:year,profile_gender:gender,userpreferlocation:cityaddress,locationid:locationid},
      crossDomain: true,
...
<script>
    $(".newlogin").click(function(){
     ...
     if(loginuser =='' || loginpassword ==''){
      ...
      $("#error_user").text("This is required field");
      ...
      $("#error_pass").text("This is required field.");
