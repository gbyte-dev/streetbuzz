...
<link href="<?php echo $C->SITE_URL;?>assets/home/bootstrap4.css" rel="stylesheet" >
   <!--  <link  href="<?php echo $C->SITE_URL;?>assets/home/font-awesome.min.css" rel="stylesheet"> -->
    <link href="<?php echo $C->SITE_URL;?>themes/FishingEnthusiastTheme/css/glyphicon.css?v=3.6.0" type="text/css" rel="stylesheet" />
...
<link href="<?php echo $C->SITE_URL;?>assets/home/docs.css" rel="stylesheet">
...
$btns ='
   ...
   /*$btns ='
       <a class="btn credit" href="" style="float:right;margin-top:13px;margin-right:10px">Sign Up</a> <a class="btn credit" href="" style="float:right;margin-right:10px;margin-top:13px">Login</a> ';*/
$imgwidth ='166px';
...
<header class="<?php echo $css;?>">
  ...
  <img width="<?php echo $imgwidth;?>" src="https://streetbuzz.co.in/newsapp/static/images/streetbuzz.jpg" class="img-responsive">
</a>
<?php  echo $btns;?>
 ...
 <div class="top_news_wrap">
     ...
     <a class="bd-toc-link stn">
         State News
        	...
        	<div class="bd-toc-item">
      <a class="bd-toc-link <?php echo $mainactive;?>" href="<?php echo $C->SITE_URL?>newhome">
        Top News
      </a>
	...
	<div class="bd-toc-item">
      <a class="bd-toc-link <?php echo $apactive;?>" href="<?php echo $C->SITE_URL?>newhome?st=ap" >
        Andhrapradesh
      </a>
	...
	<div class="bd-toc-item">
      <a class="bd-toc-link <?php echo $telactive;?>" href="<?php echo $C->SITE_URL?>newhome?st=tel">
        Telangana
      </a>
	...
	<div class="bd-toc-item">
      <a class="bd-toc-link <?php echo $jhaactive;?>" href="<?php echo $C->SITE_URL?>newhome?st=jha" >
        Jharkhand
      </a>
	...
	<div class="bd-toc-item">
      <a class="bd-toc-link <?php echo $bhiactive ?>"  href="<?php echo $C->SITE_URL?>newhome?st=bhi" >
        Bihar
      </a>
...
<ul>
          ...
          <?php
            if(empty($_GET)){
          	...
          	left join posts_attachments as pa ON pa.post_id=p.id WHERE h.main_or_not ="'.$yes.'" group by p.id order by p.id desc  LIMIT 10');
          	...
          	inner join posts as p ON p.id=h.post_id 
          	inner join users as u ON p.user_id=u.id
          	left join posts_attachments as pa ON pa.post_id=p.id WHERE h.language="'.$state.'" group by p.id order by p.id desc LIMIT 10');
                }elseif($_GET['search']){
                   $state=  $search =$_GET['search'];
                    $searching =1; 
               $res =	$db2->query('SELECT p.id,p.message,pa.type,pa.data,u.username FROM posts as p 
          	inner join users as u ON p.user_id=u.id
          	left join posts_attachments as pa ON pa.post_id=p.id WHERE p.message like "%'.$search.'%" group by p.id order by p.id desc LIMIT 10');
...
<div style="font-weight:bold;"><?php echo $newstype;?> News</div>
...
<span class="grey_text">Remember me <a href="https://streetbuzz.co.in/newsapp/signin/forgotten" class="link_blue_text">Forgot password?</a></span></div><br />
        <div class="margin10">
