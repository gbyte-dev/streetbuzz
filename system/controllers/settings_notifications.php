<?php
	...
	if( isset($_POST['sbm']) ) {
		...
		$i['ntf_me_if_u_like_buzz']	= (isset($p['ntf_me_if_u_like_buzz'])	 && in_array($p['ntf_me_if_u_like_buzz'], array(1, 2, 3, 0)) )	? intval($p['ntf_me_if_u_like_buzz']) : 0;
        $i['ntf_me_if_u_rebuzz_buzz']	= (isset($p['ntf_me_if_u_rebuzz_buzz'])	 && in_array($p['ntf_me_if_u_rebuzz_buzz'], array(1, 2, 3, 0)) )	? intval($p['ntf_me_if_u_rebuzz_buzz']) : 0;
        $i['ntf_me_if_u_share_buzz']	= (isset($p['ntf_me_if_u_share_buzz'])	 && in_array($p['ntf_me_if_u_share_buzz'], array(1, 2, 3, 0)) )	? intval($p['ntf_me_if_u_share_buzz']) : 0;
	    $i['ntf_me_if_u_follow_buzz']	= (isset($p['ntf_me_if_u_follow_buzz'])	 && in_array($p['ntf_me_if_u_fololow_buzz'], array(1, 2, 3, 0)) )	? intval($p['ntf_me_if_u_follow_buzz']) : 0;
	...
	$rows = array(
			...
			$table->radioButton( $this->lang('os_st_notif_ntf_me_if_u_like_my_post'), 'ntf_me_if_u_like_buzz', array('0'=>'None', '2'=>'Post', '3'=>'E-mail', '1'=>'Both' ), $i['ntf_me_if_u_like_buzz'] ),
            $table->radioButton( $this->lang('os_st_notif_ntf_me_if_u_rebuzz_my_post'), 'ntf_me_if_u_rebuzz_buzz', array('0'=>'None', '2'=>'Post', '3'=>'E-mail', '1'=>'Both' ), $i['ntf_me_if_u_rebuzz_buzz'] ),
            $table->radioButton( $this->lang('os_st_notif_ntf_me_if_u_share_my_post'), 'ntf_me_if_u_share_buzz', array('0'=>'None', '2'=>'Post', '3'=>'E-mail', '1'=>'Both' ), $i['ntf_me_if_u_share_buzz'] ),
            
            $table->radioButton( $this->lang('os_st_notif_ntf_me_if_u_follow_my_post'), 'ntf_me_if_u_follow_buzz', array('0'=>'None', '2'=>'Post', '3'=>'E-mail', '1'=>'Both' ), $i['ntf_me_if_u_follow_buzz'] ),
	...
	$tpl->layout->block->setVar('empty_block_content', $table->createTableInput($rows, 'notifications-table'));
