  ...
  <button class="btn btn-link bd-search-docs-toggle d-md-none p-0 ml-3" type="button" data-toggle="collapse" data-target="#bd-docs-nav" aria-controls="bd-docs-nav" aria-expanded="false" aria-label="Toggle docs navigation"><i class="fa fa-bars" aria-hidden="true"></i>
    ...
    <div class="container-fluid">
      <div class="row flex-xl-nowrap">
        <div class="col-12 col-md-3 col-xl-3 bd-sidebar scrollbar">
...
<nav class="collapse bd-links force-overflow" id="bd-docs-nav">
 <div class="top_news_wrap">
     ...
     <a class="bd-toc-link stn">
        ...
        <h4 class="text-center">Top News</h4>
 ...
 <?php 
    ...
    <div class="card-body">
        ...
        <?php }else{?>
        <a href="<?php echo $C->SITE_URL?>home?st=<?php echo $value['id'].'&name='.$value['name']; ?>" >
        <img style="width:100%;height:150px;border-radius: 10px;" alt="Image3" src="https://streetbuzz.co/develop/storage/attachments/1/627e45394271d.png">
        </a>
        <?php } ?>
        <a href="<?php echo $C->SITE_URL?>home?st=<?php echo $value['id'].'&name='.$value['name']; ?>" >
        <p class="mt-2" style="font-size: small; color: #2c6b82;"><?php echo $value['name']; ?> - <?php echo $value['native']; ?></p>
        </a>
...
<div class="card">
    <div class="card-body">
        <img style="width:100%;height:150px;border-radius: 10px;" alt="Image1" src="https://streetbuzz.co/develop/storage/attachments/1/627e45394271d.png">
...
<?php } ?>
    ...
    <?php }  ?>
          ...
          <div class="d-none d-xl-block col-xl-3 bd-toc">
              <h4 class="text-center">Top Trending</h4>
              <div class="card">
...
?>
<br>
<h4>Tpp News in <?php echo $_GET['name']; ?></h4>
...
<div class="col-sm-6" style="background:none;border:none;"><div style="background:none;border:none;float:left"><img style="height:50px;width:50px;border-radius:50%" src="<?= $avatar ?>"></div><div style="background:none;border:none;float:left;padding-left: 10px;">
...
<div class="col-sm-6" style="text-align: end;background:none;border:none;"><button class="btn btn-primary"><a style="text-decoration:none;color:white" href="<?= $C->SITE_URL ?><?php echo $result->username;?>"><i class="fa fa-plus"></i>Follow</a></button><br>
<span style="font-size:10px"><?php echo  parse_date1($result->date);  ?> | <?php echo getlikescount('views',$result->id); ?> views</span>
...
<?php 
     if($ismobile == 0 ){ ?>
     <img width="92%"  class="imgresponsive 1111111111"src="<?php echo  $C->SITE_URL?>/storage/advs/<?php echo $singleresult[$s]->ads_image ?>"  />
  <?php }else{ ?>
