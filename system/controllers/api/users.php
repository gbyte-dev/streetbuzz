<?php
	...
	// require_once( $C->INCPATH.'classes/class_twitterdata.php' );	require_once( '../../helpers/func_api.php' );	require_once( '../../classes/class_oauth.php' );	require_once( '../../classes/class_twitterdata.php' );
	print_r($_POST);exit;
