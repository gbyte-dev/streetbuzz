...
//return;
	...
	{ 	 
 return;
	    require_once('../../../classes/class_oauth.php');
	...
	$oauth_client = new OAuth($_REQUEST['oauth_consumer_key'], $_REQUEST['oauth_nonce'], $_REQUEST['oauth_signature'], $_REQUEST['oauth_timestamp']); 
		...
		if(
		$oauth_client->is_valid_consumer_key()
	/*	&& 
		$oauth_client->is_valid_nonce()
		&&
		$oauth_client->is_valid_timestamp()
		&&
		(strtolower(urldecode($_REQUEST['oauth_signature_method'])) == 'hmac-sha1')
		&&
