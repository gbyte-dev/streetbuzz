...
<li><input id="check1" type="radio" name="understand_financial" value="beginner" checked>
      <label for="check1" >Beginner</label></li>
<li><input id="check3" type="radio" name="understand_financial" value="intermediate">
      <label for="check3">Intermediate</label></li>
<li><input id="check4" type="radio" name="understand_financial" value="expert">
      <label for="check4">Expert</label></li>
<li><input id="check5" type="radio" name="understand_financial" value="maestro">
      <label for="check5">Maestro</label></li>
</ul>
