...
<div class="modal-dialog" id="graph-chat" >
   ...
   <div class="modal-content">
      <div class="modal-header">
         ...
         <h4 class="modal-title">Reply to @srinivasarao annam </h4>
      </div>
      <div class="modal-body">
         <div>
            <div class="activity no-comments commentcontainer" style="margin-top:43px;">
               <!-- start Parent -->
               <div class="row" style="padding:0px 10px;">
                  <div class="col-md-12 col-xs-12 buzz-parent-box">
                     <div class="col-md-1" style="overflow:hidden"><a href="<?php echo userlink($result->username); ?>" class="avatar bizcard" data-userid="<?php echo userlink($result->user_id); ?>"><img src="<?php echo getAvatarUrl($result->avatar, 'thumbs1')?>" alt="<?php echo $result->username?>" /></a>
                     </div>
                     <div class="col-md-11 col-xs-11" style="padding:0px 3px 0px 8px;">
                        <div class="activity-container">
                           <div class="activity-header col-md-12"><a href="<?php echo userlink($result->username); ?>" class="author bizcard" data-userid="<?php echo userlink($result->user_id); ?>"><?php echo ($result->username); ?></a>
                           </div>
	...
	<?php if($eventtype == 7 || $eventtype == 8 || $eventtype == 9 || $eventtype == 10 ){ ?>
...
?>
<!--poll creation -->
		 <div id="poll" class="create_poll" style="display: <?php echo $pollcss;?>;"><div>
...
?>
		 <!-- poll end-->
		 <div id="eventdata" class="eventdata" style="display:<?php echo $eventcss;?>;">
		 <!--event creation -->
   ...
   <div id="urtxt" style="padding:0" class="urtxt"><input type="text" class="form-control usertxt" class="group" id="usertxt-<?php echo $childid;  ?>" autocomplete="off"  value="" placeholder="Users" name="street_user"  /></div>
	...
	<input type="hidden" id="act" class="act" value="">
		 ...
		 <!--end event creation-->
			...
			<?php if($eventtype ==1 || $eventtype ==2 || $eventtype ==3 ){ ?>
				<input type="text" id="action" class="action" value='event'>

			<?php }elseif($eventtype == 4 || $eventtype == 5 || $eventtype == 6 ){ ?>
	<input type="text" id="action" class="action" value='poll'>			
	<?php }elseif($eventtype == 7 || $eventtype == 8 || $eventtype == 9 || $eventtype == 10 ){  ?>
		<input type="text" id="action" class="action" value='buzz'>			
...
<span data-value="999" class="post-cal">999</span> 
   <?php } ?>
   <?php if($eventtype ==1 || $eventtype ==2 || $eventtype ==3 ){ ?>
            <button   onclick="commenteventtimelines(<?php echo $postid; ?>,<?php echo $childid; ?>,<?php echo $eventtype; ?>)" type="button" id="<?php echo $postid; ?>" class="eventpost comment-post comment-post post-btn btn  blue center">Buzz</button>

	   
  <?php  }elseif($eventtype ==4 || $eventtype ==5 || $eventtype ==6){ ?>
   <button   onclick="commentpolltimelines(<?php echo $postid; ?>,<?php echo $childid; ?>,<?php echo $eventtype; ?>)" type="button" id="<?php echo $postid; ?>" class="pollpost comment-post comment-post post-btn btn  blue center">Buzz</button>

	   
   <?php }elseif($eventtype ==7 || $eventtype ==8 || $eventtype ==9 || $eventtype ==10){ ?>
     <button   onclick="commentintradaytimelines(<?php echo $postid; ?>,<?php echo $childid; ?>,<?php echo $eventtype; ?>)" type="button" id="<?php echo $postid; ?>" class="intrapost comment-post comment-post post-btn btn  blue center">Buzz</button>

	   
   <?php }
   ?>
            <button  style="display:none;" onclick="commenttimelines(<?php echo $postid; ?>,<?php echo $childid; ?>)" type="button" id="<?php echo $postid; ?>" class="comment-post  comment-post post-btn btn  blue center buzzpost">Buzz</button>
