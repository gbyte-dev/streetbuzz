...
<div class="modal-dialog graph-<?php echo $childid;?>" >
   ...
   <div class="modal-content">
      <div class="modal-header">
         ...
         <h4 class="modal-title">Replies of @srinivasarao annam </h4>
      </div>
      <div class="modal-body">
         <?php foreach($res as $keys=>$result){
			...
			if(!empty($assetdata)){
				$parentmessage = assethtml($result->id);
	        }elseif(!empty($eventdetails)){
				$parentmessage = eventhtml($result->id);
			}elseif(!empty($poll)){
				$parentmessage = pollhtml($result->id);
            ...
            $sha= '<div class="dropdown">
               ...
               <ul class="menu-options">
            	  <li><a href="http://www.linkedin.com/shareArticle?mini=true&url='.urlencode($C->SITE_URL.'/view/post:'.$result->id).'&title='.urlencode(htmlspecialchars($result->message)).'&source='.urlencode($C->SITE_URL.'/view/post:'.$result->id).'&summary='.urlencode($C->SITE_URL.'/view/post:'.$result->id).'"  target="_blank" >Linkedin</a></li>
            	  <li><a href="http://www.stumbleupon.com/submit?url='.urlencode($C->SITE_URL.'/view/post:'.$result->id).'  target="_blank" >StumbleUpon</a></li>
            	  <li><a href="http://www.myspace.com/Modules/PostTo/Pages/?u='.urlencode($C->SITE_URL.'/view/post:'.$result->id).'  target="_blank" >MySpace</a></li>
            	  <li><a href="http://friendfeed.com/?url='.urlencode($C->SITE_URL.'/view/post:'.$result->id).'&title='.urlencode(htmlspecialchars($result->message)).'  target="_blank" >FriendFeed</a></li>
            ...
            ?>
         <div id="replaypopup<?php echo $eventtype?>-<?php echo $postid;?>"></div>
         <div>
                           ...
                           <div class="col-md-11 col-xs-11" style="padding:0px 3px 0px 8px;">
                              ...
                              <div class="col-md-12">
                                 <div class="activity-footer meta-info">
                                    <i class="fa fa-clock-o">&nbsp;&nbsp;</i><a href="<?php echo $C->SITE_URL?>/view/post:<?php echo $postid ;?>" class="permlink"><?php echo post::parse_date($result->date); ?></a>
                                    ...
                                    <div class="like-list"><a href="" data-role="services" data-namespace="activities" data-action="<?php  if($is_likedreplay){ echo 'unlike'; }else{ echo 'like';}?>" <?php echo $dat;?>><?php if($is_likedreplay){ ?><img  src="<?php echo $C->SITE_URL?>static/images/icons/LIKE.png"  title="Like"/><?php }else{ ?> <img  src="<?php echo $C->SITE_URL?>static/images/icons/LIKE.png" class="icons"  title="Like"/><?php }?> </a><?php echo $showlikes_btn;?></div>
                                    <div class="agree-list"><a href="" data-role="services" data-namespace="activities" data-action="<?php  if($is_agree){ echo 'disagree'; }else{ echo 'agree';}?>" <?php echo $dat;?>> <?php if($is_agree){ ?><img width="30px" src="<?php echo $C->SITE_URL?>static/images/icons/a2d.png"  title="Like"/><?php }else{ ?> <img width="30px" src="<?php echo $C->SITE_URL?>static/images/icons/a2d.png" class="icons"  title="Like"/><?php }?></a><?php echo $showagreebtn_btn;?></div>
                                    <span class="reshare-list"><?php echo $reshare_content ?><?php echo $resharecnt ?></span>
                                    <?php echo $sha;?>
                                 </div>
                                 <?php if($_POST['view_type'] =="view"){if(!empty($parentiddd)){
                                    ...
                                    ?>
                                 <div ><a style="color:blue;cursor:pointer;" onclick="replaycontentalllevels(<?php echo $parentid; ?>,<?php echo $result->id?>,<?php echo $firstval;?>,<?php echo $eventtype?>)" class="pull-right" >View Replies</a></div>
							  ...
							  <?php if($eventtype == 7 || $eventtype == 8 || $eventtype == 9 || $eventtype == 10 ){?>
                                 <div class="user-status-field htmlarea userreplaybuzz-<?php echo $result->id;?>" style="margin-top: 48px;">
							  ...
							  <?php }  ?>
								 ...
								 ?>
                                 <!--poll creation -->
                                 <div id="poll-<?php echo $result->id;?>" class="create_poll-<?php echo $result->id;?>" style="display: <?php echo $pollcss;?>;">
                                    <div>
								 ...
								 ?>
                                 <div id="eventdata-<?php echo $result->id;?>" class="eventdata-<?php echo $result->id;?>" style="display:<?php echo $eventcss;?>;">
                                    <!--event creation -->
							  ...
							  <?php   if($eventtype == 1 || $eventtype == 2 || $eventtype == 3){
                                 $eventval ="event";								  
							  	...
							  	<input type="hidden" id="action-<?php echo $result->id;?>" class="action" value='<?php echo $eventval;?>'>
...
<span data-value="999" class="post-cal">999</span> 
		...
		<?php 
		if($eventtype ==1 || $eventtype ==2|| $eventtype ==3  ){ ?>
		 <button   onclick="commenteventalllevels(<?php echo $parentid; ?>,<?php echo $result->id; ?>,<?php echo $firstval; ?>,<?php echo $eventtype?>)" type="button" id="<?php echo $postid; ?>" class="eventpost-<?php echo $result->id;?> comment-post comment-post post-btn btn  blue center">Buzz</button>

			
		<?php }elseif($eventtype ==4 || $eventtype ==5|| $eventtype ==6){ ?>
 <button   onclick="commentpollalllevels(<?php echo $parentid; ?>,<?php echo $result->id; ?>,<?php echo $firstval; ?>,<?php echo $eventtype?>)" type="button" id="<?php echo $postid; ?>" class="pollpost-<?php echo $result->id;?> comment-post comment-post post-btn btn  blue center">Buzz</button>
			
		<?php }elseif($eventtype ==7 || $eventtype ==8|| $eventtype ==9 || $eventtype ==10){ ?>
			  <button   onclick="commentintradayalllevels(<?php echo $parentid; ?>,<?php echo $result->id; ?>,<?php echo $firstval; ?>,<?php echo $eventtype?>)" type="button" id="<?php echo $postid; ?>" class="intrapost-<?php echo $result->id;?> comment-post comment-post post-btn btn  blue center">Buzz</button>

			
		<?php }
		?>

<button  style="display:none;"  onclick="commentalllevvels(<?php echo $parentid; ?>,<?php echo $result->id; ?>,<?php echo $firstval; ?>)" type="button" id="<?php echo $postid; ?>" class="comment-post comment-post post-btn btn  blue center buzzpost-<?php echo $result->id;?>">Buzz</button>
                                 </div>
                           </div>
                           <div></div>
                        </div>
...
<script type="text/javascript">
   ...
   function replaycontentalllevels(postid,childid,main,eventtype){
   	...
   	$.ajax({
   	           ...
   	           cache: false,
   				...
   				success:function(msg){
   					 ...
   					 $('#replaypopup'+eventtype+'-'+main).html('');
   					 $('#replaypopup'+eventtype+'-'+main).html(msg);
   					 $('#replaypopup'+eventtype+'-'+main).modal('show'); 
