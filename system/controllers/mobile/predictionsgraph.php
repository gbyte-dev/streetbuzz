...
if($_POST['ticker']){
   $ticker = $_POST['ticker'];
    ...
    $historical_query            =$db2->query('SELECT price,price_date FROM asset_historical_data WHERE ticker="'.$historicalsymbol.'" AND price_date >=now()- interval 3 month order by price_date ASC ');
 ...
 <div class="modal-dialog" id="graph-chat" >
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Basic Chart</h4>
        </div>
        <div class="modal-body">
         <div class="container" style="width:500px;height: 400px"></div>
		<!--<div id="drag"></div>
		<div id="drop"></div>-->
       ...
       <button type="button" class="btn btn-info btn-lg show-modal" data-toggle="modal" data-target="#next" id="next-process" disabled>Next</button>
      </div>
...
<span data-notify-text="" class="notifyjs-text">This field is required</span>
 ...
 <div class="col-md-4">
		  ...
		  <div class="col-md-4" >
                ...
                <span class="titleModal">End Date:</span><span><input  id="graphdate" class="form-control" type="text" readonly value="" name="enddate" /></span>
		  ...
		  <div id="reason-error"class="notifyjs-container" style="top: 120px; left: 21px; overflow: hidden; display: hidden;"><div class="notifyjs-bootstrap-base notifyjs-bootstrap-error">
            <span data-notify-text="" class="notifyjs-text">This field is required</span>
         </div></div>
</div>
      ...
      <div class="modal-footer">
	   <?php if($userlevel =="EXPERT" || $userlevel =="MAESTRO"){?>
        <button id="resaonsfill" type="button" class="btn btn-default btn-primary" data-toggle="modal" data-target="#afterreason" >Next</button>
	   <?php }else{ ?>
		        <button  type="button" class="btn btn-default btn-primary" data-toggle="modal" data-target="#simulate" id="resaonsfill"  >Next</button>
  ...
  <div class="modal fade" id="afterreason" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
      ...
      <div class="modal-content" >
        <div class="modal-header">
          <button type="button" class="close" >&times;</button>
          <h4 class="modal-title">How much you want to put on this prediction?</h4>
        </div>
        <div class="modal-body">
		     <div class="row">
			     <div class="col-md-4" >
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-default" id="predict_next" data-toggle="modal" data-target="#simulate">Next</button>
        </div>
      </div>
  ...
  <div class="modal fade" id="simulate" role="dialog" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog">
      ...
      <div class="modal-content" >
        ...
        <div class="modal-body">
		     <div class="row">
			     <div >
			             ...
			             <label><input type="radio" name="simulatetype" value="yes" checked>Yes</label>

                 </div>
				 <div >
			 
			        	<label><input type="radio" name="simulatetype" value="no">No</label>
        ...
        <div class="modal-footer">
          <input type="submit" class="btn btn-default" id="predict_next" data-toggle="modal" value="Done"></button>
        </div>
		</form>
      </div>
...
<script>
  ...
  <style>
#country-list{float:left;list-style:none;margin-top: -10px;padding:0;width:190px;}
