                           ...
                           <div class="col-md-11 col-xs-11" style="padding:0px 3px 0px 8px;">
                              ...
                              <div class="col-md-12">
                                 ...
                                 <?php if($_POST['view_type'] =="view"){if(!empty($parentiddd)){
                                    ...
                                    ?>
                                 <div ><a style="color:blue;cursor:pointer;" onclick="replaycontentalllevels(<?php echo $parentid; ?>,<?php echo $result->id?>,<?php echo $firstval;?>)" class="pull-right" >View Replies</a></div>
                              ...
                              <div id="con-<?php echo $result->id; ?>" style="display:none;" class="cons" rel="<?php echo $result->id;?>">
                                 ...
                                 <input type="text" id="asset_val" value="1"></input>
                                 <div class="replayslide-<?php echo $result->id;?>" ></div>
                                 <input type="text"  class="replayticker1-<?php echo $result->id;?>">
