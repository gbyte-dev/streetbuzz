    ...
    $datares    	.='<div class="col-md-6 content-bg">	
	 <div id="content-container">
		...
		<div id="center-container">
		       <h3>Select Appropriate Topics</h3><table class="form-container "><tbody>
			    <tr>
					<td class="field-title"><label for="network_name">Topic Literal<span style="
    color: red;
">*</span>:</label></td>
					<td><input type="text" id="topic_name" class="errormes" name="topic_name"  maxlength="50" autocomplete="off" value=""></td>
				</tr>
					<tr>
...
">*</span>:</label></td>
        	...
        	<tr>
					...
					<td><select name="topic_category" id="topic_category"><option value="">Select Category</option>
				    '.$categeory_masterhtml.'
					</select></td>
				</tr>
					...
					<td><select name="topic_location" id="topic_location"><option value="">Select Location</option>
				   '.$location_masterhtml.'
					</select></td>
				</tr>
				<tr>
					<td class="field-title"><label for="network_intro_txt">Attach Language:</label></td>
					<td><select name="topic_language" id="topic_language"><option value="">Select Language</option>
				   '.$language_masterhtml.'
					</select></t
					d>
				</tr>
...
">*</span>:</label></td>
			...
			<tr>
					...
					<td><button  class="btn blue adsv"><span>Find</span></button></td>
				</tr></tbody></table>
...
var topic_location = $("#topic_location").val();
var topic_language = $("#topic_language").val();
var start_date = $("#start_date").val();
var end_date = $("#end_date").val();


	var url = "'.$C->SITE_URL.'/admin/searchtopicajax"; 
			jQuery.ajax({
				type:"POST",
				data:{topic:topic,description:description,topic_category:topic_category,topic_location:topic_location,topic_language:topic_language,start_date:start_date,end_date:end_date},
				cache:false,
				dataType: "json",
               ...
               url: url
          		...
          		if(response.status == 200){
          	     $("#ajaxcontent").html(response.response);	
