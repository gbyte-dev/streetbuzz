...
foreach($D->follow as $keys=>$vals ){
	if(!empty($D->follow[$keys])){
	 if($vals->avatar !=''){
	 $src=$C->SITE_URL.'storage/avatars/thumbs1/'.$vals->avatar;
	...
	<div class="follow-data-bor" id="follow'.$vals->id.'">
	  ...
	  <a href="'.$C->SITE_URL.''.$vals->username.'">'.$img.'</a>
			...
			<img height="22px" src="'.$C->SITE_URL.'storage/attachments/1/close.jpg" class="pull-right"  style="cursor: pointer;">
			</div>
			</div>
...
/* Start : Polls */
			...
			<div class="col-md-12 box-footer">
			<div class="col-md-4 box-footer-left"><a href="'.$C->SITE_URL.'notification/tab:polls/req:myresponse">View All</a>
			</div>
...
/* End : Polls */
		/* Start : Contact */
			...
			<li><a href="'.$C->SITE_URL.'contacts">Feedback</a></li>
			</ul>
			</p>
			</div>
...
/* Start : Footer */
			...
			<div class="footer-text">
			<p>&copy; 2021 Street Buzz. <br />
			<ul class="list-inline">
			<li><a  href="'.$C->SITE_URL.'privacy-terms-rules/about/" target="_blank" >About</a></li>
			<li><a  href="'.$C->SITE_URL.'privacy-terms-rules/support/" target="_blank">Support</a></li>
			<li><a href="'.$C->SITE_URL.'contacts" target="_blank">Feedback</a></li>
			<li><a href="'.$C->SITE_URL.'contacts" target="_blank">Contact</a></li>
...
/* Start : Profile */
			...
			<div class="profile-top"><a href="'.$C->SITE_URL.''.$user->info->username.'">
			...
			<div class="box-title">
			<a href="'.$C->SITE_URL.''.$user->info->username.'">'.$user->info->fullname.'<br /> <span class="box-sub-desc">@'.$user->info->username.'</span></a>
			</div>
