...
array('url' => 'admin/appversion', 'css_class' => (($tab === 'appversion')? ' selected' : ''), 'title' =>'Android App Version' ),
...
array('url' => 'admin/homeaddsdisplay', 'css_class' => (($tab === 'homeaddsdisplay')? ' selected' : ''), 'title' =>'LocationBased Advt.Mgmt' ),
...
array('url' => 'admin/manage_registration',		'css_class' => (($tab === 'manage_registration')? ' selected' : ''), 	'title' => 'Manage Registration' ),
array('url' => 'admin/manage_payment',		'css_class' => (($tab === 'manage_payment')? ' selected' : ''), 	'title' => 'Manage Payment' ),
array('url' => 'admin/manageFollow',		'css_class' => (($tab === 'manageFollow')? ' selected' : ''), 	'title' => 'Manage Auto Follow' ),
