...
require_once $C->PLUGINS_DIR."events/system/libraries/google/src/Google/Cache/Abstract.php";
require_once $C->PLUGINS_DIR."events/system/libraries/google/src/Google/Cache/Exception.php";
