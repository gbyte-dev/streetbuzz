<div class="content pad"> 
    ...
    <input type="text" class="form-control" id="title" data-validate="required" name="title" placeholder="Title" value="<?php echo isset($_POST['title'])?$_POST['title']:'';?>" maxlength="50" autocomplete="off">
    </div>
    ...
    <div class="col-md-11" style="padding:0">
    <input type="text" class="form-control" id="address" data-validate="required"  name="address" placeholder="Where?" value="<?php echo isset($_POST['address'])?$_POST['address']:'';?>" maxlength="50" autocomplete="off" placeholder="Enter a location">
    </div>
   
    <input id="group_id" name="group_id" type="text" value="{%group_id%}" size="30">
    ...
    <div class="col-md-11" style="padding:0">
    <input type="text" class="form-control" id="url"  name="url" placeholder="URL" value="<?php echo isset($_POST['address'])?$_POST['address']:'';?>" maxlength="50" autocomplete="off" placeholder="Enter a location"> 
    </div>
    <div class="col-md-1">
    ...
    <input type="text" class="form-control" autocomplete="off"  id="hastag" name="hastag" placeholder="hashtag" >
    ...
    <div class="col-md-12" id="grpuser" style="padding:0;display:none;">
    <div class="col-md-11" style="padding:0">
    ...
    <div class="col-md-1">
    <a href="#" id="closegrpuser"><span class="glyphicon glyphicon-remove"></span></a>
    </div>
    </div>
    ...
    <div class="col-md-12" style="padding:0"><button type="submit" name="submit4545" class="btn blue"><span>Buzz</span></button></div>
