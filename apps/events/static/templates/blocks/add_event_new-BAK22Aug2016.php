...
<!--/ END : Date n time -->
    ...
    <div class="col-xs-11 col-md-11" style="padding:0">
    <div id="grtxt" style="padding:0"><input type="text" class="form-control" class="htmlarea textarea group"id="grouptxt" autocomplete="off"  value="" placeholder="Group" name="street_group" /></div>
    </div>
