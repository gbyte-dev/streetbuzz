	...
	if($_GET['action']=="download")
{
	...
	die("Database could not be selected"); 		
		...
		$sql = mysqli_query($connection,"select p.poll_question,pa.answer,u.username from post_poll_votes as ppv
		...
		// Get The Field Name
		$headingdes = array("Pollquestion","Answer","Username");
...
/********************* Start: Timeline Buzz Parent Reply **********************/
   ...
   <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 buzz-parent-box">
         ...
         <a href="'.userlink($parentres->username).'" class="pull-left  bizcard" data-userid="'.$parentres->userid.'"><img src="'.getAvatarUrl($parentres->pic, 'thumbs1').'" alt="'.$parentres->username.'" /></a>
			</div>
   ...
   <div class="col-md-11 col-lg-11 col-sm-11 col-xs-10" style="padding:0px 3px 0px 8px;">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 zeropadding">
             <div class="activity-footer meta-info col-lg-12 col-md-12 col-sm-12 col-xs-12 zeropadding admin-margin-footer-popup">
                 <i class="fa fa-clock-o">&nbsp;&nbsp;</i><a href="'.$C->SITE_URL.'/view/post:'.$parentid.'" class="permlink">'.$date.'</a>
				...
				<div class="like-list"><a href="" data-role="services" data-namespace="activities" data-action="'.($is_liked? 'unlike' : 'like').'" data-value="'.htmlentities('{"activities_type":"public","activities_id":"'.$parentid.'"}').'">'.($is_liked? '<img  src="'.$C->SITE_URL.'static/images/icons/LIKE.png"  title="Like"/>' : '<img class="icons" src="'.$C->SITE_URL.'static/images/icons/LIKE.png"  title="Like"/>').'</a>'.$showlikes_btn.'</div>
				<div class="agree-list"><a href="" data-role="services" data-namespace="activities" data-action="'.($is_agree? 'disagree' : 'agree').'" data-value="'.htmlentities('{"activities_type":"public","activities_id":"'.$parentid.'"}').'">'.($is_agree? '<img  width="30px" src="'.$C->SITE_URL.'static/images/icons/a2d.png"  title="Disagree"/>' : '<img width="30px" class="icons" src="'.$C->SITE_URL.'static/images/icons/a2d.png"  title="Agree"/>').'</a>'.$showagreebtn_btn.'</div>
...
/********************* START: Timeline Buzz Parent Reply **********************/
		...
		$cnt.='<div class="activity no-comments commentcontainer'.$replayid.'" style="border: 0px solid #E1E8ED;" id="'.$chi.'">
...
<div class="col-md-1 col-lg-1 col-sm-1 col-xs-2 image-div" style="padding:0; overflow:hidden"><a href="'.userlink($row->username).'" class="pull-left  bizcard" data-userid="'.$row->userid.'"><img src="'.getAvatarUrl($row->pic, 'thumbs1').'" alt="'.$row->username.'" /></a>
			</div>
...
<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 zeropadding">
 <div class="activity-footer meta-info col-lg-12 col-md-12 col-sm-12 col-xs-12 zeropadding">
				<i class="fa fa-clock-o">&nbsp;&nbsp;</i><a href="'.$C->SITE_URL.'/view/post:'.$row->replayid.'" class="permlink">'.$date.'</a>
				...
				<div class="like-list"><a href="" data-role="services" data-namespace="activities" data-action="'.($is_liked? 'unlike' : 'like').'" data-value="'.htmlentities('{"activities_type":"public","activities_id":"'.$row->replayid.'"}').'">'.($is_liked? '<img  src="'.$C->SITE_URL.'static/images/icons/LIKE.png"  title="Like"/>' : '<img class="icons" src="'.$C->SITE_URL.'static/images/icons/LIKE.png"  title="Like"/>').'</a>'.$showlikes_btn.'</div>
				<div class="agree-list"><a href="" data-role="services" data-namespace="activities" data-action="'.($is_agree? 'disagree' : 'agree').'" data-value="'.htmlentities('{"activities_type":"public","activities_id":"'.$row->replayid.'"}').'">'.($is_agree? '<img  width="30px" src="'.$C->SITE_URL.'static/images/icons/a2d.png"  title="Disagree"/>' : '<img width="30px" class="icons" src="'.$C->SITE_URL.'static/images/icons/a2d.png"  title="Agree"/>').'</a>'.$showagreebtn_btn.'</div>
               	<span class="reshare-list">'.$reshare_content.''.$resharecnt.'</span>

                  <div class="dropdown">
							   <a style="cursor:pointer" href="" class="menu-btn"><img class="icons" src="'.$C->SITE_URL.'static/images/icons/SHARE.png" title="Share"/></a>
							   <ul class="menu-options">
								  <li><a href="http://www.linkedin.com/shareArticle?mini=true&url='.urlencode($C->SITE_URL.'/view/post:'.$row->replayid).'&title='.urlencode(htmlspecialchars($row->message)).'&source='.urlencode($C->SITE_URL.'/view/post:'.$row->replayid).'&summary='.urlencode($C->SITE_URL.'/view/post:'.$row->replayid).'"  target="_blank" >Linkedin</a></li>
								  <li><a href="http://www.stumbleupon.com/submit?url='.urlencode($C->SITE_URL.'/view/post:'.$row->replayid).'  target="_blank" >StumbleUpon</a></li>
								  <li><a href="http://www.myspace.com/Modules/PostTo/Pages/?u='.urlencode($C->SITE_URL.'/view/post:'.$row->replayid).'  target="_blank" >MySpace</a></li>
								  <li><a href="http://friendfeed.com/?url='.urlencode($C->SITE_URL.'/view/post:'.$row->replayid).'&title='.urlencode(htmlspecialchars($row->message)).'  target="_blank" >FriendFeed</a></li>
								  <li><a href="http://plus.google.com/share?url='.urlencode($C->SITE_URL.'/view/post:'.$row->replayid).'"  target="_blank" >Google Plus</a></li>
							   </ul>
							</div>
    ...
    <a href="'.userlink($replayparentres->username).'" class="pull-left  bizcard" data-userid="'.$replayparentres->userid.'"><img src="'.getAvatarUrl($replayparentres->pic, 'thumbs1').'" alt="'.$replayparentres->username.'" /></a>
     ...
     <div class="col-md-11 col-lg-11 col-sm-11 col-xs-10" style="padding:0px 3px 0px 8px;">
            ...
            <div class="col-md-12 col-lg-12 col-md-12 col-sm-12 col-xs-12">
                 ...
                 <i class="fa fa-clock-o">&nbsp;&nbsp;</i><a href="'.$C->SITE_URL.'/view/post:'.$replayid.'" class="permlink">'.$date.'</a>
				...
				<div class="like-list"><a href="" data-role="services" data-namespace="activities" data-action="'.($is_liked? 'unlike' : 'like').'" data-value="'.htmlentities('{"activities_type":"public","activities_id":"'.$replayid.'"}').'">'.($is_liked? '<img  src="'.$C->SITE_URL.'static/images/icons/LIKE.png"  title="Like"/>' : '<img class="icons" src="'.$C->SITE_URL.'static/images/icons/LIKE.png"  title="Like"/>').'</a>'.$showlikes_btn.'</div>
				<div class="agree-list"><a href="" data-role="services" data-namespace="activities" data-action="'.($is_agree? 'disagree' : 'agree').'" data-value="'.htmlentities('{"activities_type":"public","activities_id":"'.$replayid.'"}').'">'.($is_agree? '<img  width="30px" src="'.$C->SITE_URL.'static/images/icons/a2d.png"  title="Disagree"/>' : '<img width="30px" class="icons" src="'.$C->SITE_URL.'static/images/icons/a2d.png"  title="Agree"/>').'</a>'.$showagreebtn_btn.'</div>
               	<span class="reshare-list">'.$reshare_content.''.$resharecnt.'</span>

                  <div class="dropdown">
							   <a style="cursor:pointer" href="" class="menu-btn"><img class="icons" src="'.$C->SITE_URL.'static/images/icons/SHARE.png" title="Share"/></a>
							   <ul class="menu-options">
								  <li><a href="http://www.linkedin.com/shareArticle?mini=true&url='.urlencode($C->SITE_URL.'/view/post:'.$replayid).'&title='.urlencode(htmlspecialchars($row->message)).'&source='.urlencode($C->SITE_URL.'/view/post:'.$replayid).'&summary='.urlencode($C->SITE_URL.'/view/post:'.$parentid).'"  target="_blank" >Linkedin</a></li>
								  <li><a href="http://www.stumbleupon.com/submit?url='.urlencode($C->SITE_URL.'/view/post:'.$replayid).'  target="_blank" >StumbleUpon</a></li>
								  <li><a href="http://www.myspace.com/Modules/PostTo/Pages/?u='.urlencode($C->SITE_URL.'/view/post:'.$replayid).'  target="_blank" >MySpace</a></li>
								  <li><a href="http://friendfeed.com/?url='.urlencode($C->SITE_URL.'/view/post:'.$replayid).'&title='.urlencode(htmlspecialchars($row->message)).'  target="_blank" >FriendFeed</a></li>
								  <li><a href="http://plus.google.com/share?url='.urlencode($C->SITE_URL.'/view/post:'.$replayid).'"  target="_blank" >Google Plus</a></li>
							   </ul>
							</div>
  ...
  <div class="modal fade-'.$prediction_data[0]->post_id.'" id="myModal-'.$prediction_data[0]->post_id.'" role="dialog">
   ...
   ';
	...
	foreach($data as $keys=>$row)
	{
		...
		$cnt.='<div id="'.$chi.'"class="activity no-comments commentcontainer'.$replayid.'" style="border: 0px solid #E1E8ED;" >
...
<div class="activity-footer meta-info col-lg-12 col-md-12 col-sm-12 col-xs-12">
				...
				<div class="agree-list"><a href="" data-role="services" data-namespace="activities" data-action="'.($is_agree? 'disagree' : 'agree').'" data-value="'.htmlentities('{"activities_type":"public","activities_id":"'.$replayid.'"}').'">'.($is_agree? '<img  width="30px" src="'.$C->SITE_URL.'static/images/icons/a2d.png"  title="Disagree"/>' : '<img width="30px" class="icons" src="'.$C->SITE_URL.'static/images/icons/a2d.png"  title="Agree"/>').'</a>'.$showagreebtn_btn.'</div>
                  ...
                  <div class="dropdown">
							   <a style="cursor:pointer" href="" class="menu-btn"><img class="icons" src="'.$C->SITE_URL.'static/images/icons/SHARE.png" title="Share"/></a>
							   <ul class="menu-options">
								  <li><a href="http://www.linkedin.com/shareArticle?mini=true&url='.urlencode($C->SITE_URL.'/view/post:'.$replayid).'&title='.urlencode(htmlspecialchars($row->message)).'&source='.urlencode($C->SITE_URL.'/view/post:'.$replayid).'&summary='.urlencode($C->SITE_URL.'/view/post:'.$replayid).'"  target="_blank" >Linkedin</a></li>
								  <li><a href="http://www.stumbleupon.com/submit?url='.urlencode($C->SITE_URL.'/view/post:'.$replayid).'  target="_blank" >StumbleUpon</a></li>
								  <li><a href="http://www.myspace.com/Modules/PostTo/Pages/?u='.urlencode($C->SITE_URL.'/view/post:'.$replayid).'  target="_blank" >MySpace</a></li>
								  <li><a href="http://friendfeed.com/?url='.urlencode($C->SITE_URL.'/view/post:'.$replayid).'&title='.urlencode(htmlspecialchars($row->message)).'  target="_blank" >FriendFeed</a></li>
								  <li><a href="http://plus.google.com/share?url='.urlencode($C->SITE_URL.'/view/post:'.$replayid).'"  target="_blank" >Google Plus</a></li>
...
<!-- end Parent -->
   ...
   <div class="row"  style="border:0px solid red; margin:0px; padding:0px;">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 buzz-parent-box" style="border:0px solid green">
        <div class="col-md-1 col-lg-1 col-sm-1 col-xs-2 image-div" style="padding:0; overflow:hidden"><a href="'.userlink($replayparentres->username).'" class="pull-left  bizcard" data-userid="'.$replayparentres->userid.'"><img src="'.getAvatarUrl($replayparentres->pic, 'thumbs1').'" alt="'.$replayparentres->username.'" /></a>
			</div><!--/ end : col-md-1 -->
 ...
 <div class="like-list">'.$mark_content.'</div>							
  ...
  //user post shared or not checking
   ...
   /******* Start: Timeline Parent - Buzz Reply > Popup Poll Reply ******/
   ...
   /******* End: Timeline Parent - Buzz Reply > Popup Poll Reply ******/
	...
	foreach($data as $keys=>$row)
	{
       ...
       $is_fav  = $buff->isfav($user->id,$row->replayid);
		...
		$pollcnt.='<div class="activity no-comments commentcontainer'.$replayid.'" style="border: 0px solid #E1E8ED;" id="'.$chi.'">
...
$intracnt.='<div class="activity no-comments commentcontainer'.$replayid.'" style="border: 0px solid #E1E8ED;" id="'.$chi.'">
...
<div class="col-md-1 col-lg-1 col-sm-1 col-xs-2 image-div" style="padding:0; overflow:hidden">
<a href="'.userlink($row->username).'" class="pull-left  bizcard" data-userid="'.$row->userid.'"><img src="'.getAvatarUrl($row->pic, 'thumbs1').'" alt="'.$row->username.'" /></a>
			</div>
...
{	
	...
	<div class='answers'>
		       ...
		       <div class="col-xs-12 col-md-12" style="padding:0;"><div class="clear"></div>
		       <a href="#" class="add-more" id="addanswers">+ Add Options (optional)</a>
		       </div>
               ';
    ...
    <input type='button' class='btn btn-xs btn-white active' id='grppoll' value='+Group' />

    <input type='button' class='btn btn-xs btn-white active' id='userpoll' value='+Add Users' />
    </div>
";
