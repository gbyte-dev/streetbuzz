...
error_reporting(0);
	...
	function loadDashboardLeftMenuNotification( $tpl, $params )
	{
		...
		$new_activities = $network->get_dashboard_tabstate($user->id, array('notifications','all', 'commented', '@me'));
		if($new_activities['@me'] > 0){
		   $mentcnt =$new_activities['@me'];
		   
	   }else{
		   $mentcnt ='';
	   }
	    if($new_activities['notifications'] > 0){
		   $notescnt =$new_activities['notifications'];
...
/* Start : Who To Follow */
			...
			<a href="'.$C->SITE_URL.'findpeople"><div class="follow-footer">
...
/* Start : Contact */
			...
			<p><span class="box-sub-title">Contact Street Buzz.</span><br />
			<ul class="list-inline box-sub-title">
			<li><a href="'.$C->SITE_URL.'invite">Invite People via e-mail</a></li>
			<li><a href="'.$C->SITE_URL.'contacts">Contacts</a></li>
			</ul>
			</p>
			</div>
...
/* Start : Profile */
			...
			<div class="col-lg-12 col-md-12 workspace-left-menu notifications active">
			<ul>
			<a class="'.$css5.'" href="'.$C->SITE_URL.'notifications"><li class="workspace-left-main-menu"><span class="glyphicon glyphicon-bell"></span> '.$page->lang('notification').' <span class="badge badge-workspace-left-menu">'.$notescnt.'</span></li></a>
			<a class="'.$css1.'"  href="'.$C->SITE_URL.'notification/tab:@me"><li class="workspace-left-main-menu"><span class="glyphicon glyphicon-bullhorn"></span> '.$page->lang('mentions').' <span class="badge badge-workspace-left-menu">'.$mentcnt.'</span></li></a>
			<a class="'.$css3.'" href="'.$C->SITE_URL.'notification/tab:polls"><li class="workspace-left-main-menu"><span class="glyphicon glyphicon-align-right"></span> '.$page->lang('polls').' <span class="badge badge-workspace-left-menu"></span></li></a>
			<a class="'.$css2.'" href="'.$C->SITE_URL.'notification/tab:event"><li class="workspace-left-main-menu"><span class="glyphicon glyphicon-calendar"></span> '.$page->lang('events').' <span class="badge badge-workspace-left-menu"></span></li></a>
			<a class="'.$css4.'" href="'.$C->SITE_URL.'notification/tab:Intraday"><li class="workspace-left-main-menu-last"><i class="fa fa-line-chart fa-profile-icons-blue" aria-hidden="true"></i> '.$page->lang('intraday').' <span class="badge badge-workspace-left-menu"></span></li></a>
			</ul>
			</div>
