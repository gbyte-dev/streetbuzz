...
<div class="modal-dialog graph-<?php echo $childid;?>" >
   ...
   <div class="modal-content">
      ...
      <div class="modal-body">
	  	  <div id="allmain-<?php echo $eventtype;?>-<?php echo $childid;?>">
		  	<div class="janeeshchild-<?php echo $eventtype;?>-<?php echo $childid;?>"></div>
         ...
         <?php foreach($res as $keys=>$result){
			...
			if(!empty($assetdata)){
				...
				$parentmessage =$buff->notificationpollchildhtml($result->id,$url,$eventtype);
		...
		$date = str_replace(array_keys($tmp), array_values($tmp), $txt);
            ...
            if($dcnt == $keys){
            $css="tree1";
						$chi ="allchild-".$eventtype."-".$childid;
         ...
         <div>
            <div class="activity no-comments commentcontainer <?php echo $chi ?>" 
            style="border:0">
               <!-- start Parent -->
                           ...
                           <div class="col-lg-11 col-md-11 col-sm-11 col-xs-10" style="padding:0px 3px 0px 8px;">
                              <div class="activity-container">
                               ...
                               <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                 ...
                                 <a style="cursor:pointer;" onclick="replaycontentalllevels(<?php echo $parentid; ?>,<?php echo $result->id?>,<?php echo $firstval;?>,<?php echo $eventtype?>)" class="pull-right" >View Replies</a></div>
       ...
       <a style="cursor:pointer;" onclick="replaycontentalllevels(<?php echo $parentid; ?>,<?php echo $result->id?>,<?php echo $firstval;?>,<?php echo $eventtype?>)" class="pull-right" >View Replies</a></div>
                              ...
                              <div id="con-<?php echo $result->id; ?>" style="display:none;" class="cons" rel="<?php echo $result->id;?>">
                                 ...
                                 <div id="poll-<?php echo $result->id;?>" class="create_poll-<?php echo $result->id;?>" style="display:none;">
                                    ...
                                    <style>
										.janeeshchild-<?php echo $eventtype;?>-<?php echo $childid;?>{
											position: absolute; 
...
<span data-value="999" class="post-cal">999</span> 
		 ...
		 <button   style="display:none;" onclick="commenteventalllevels(<?php echo $parentid; ?>,<?php echo $result->id; ?>,<?php echo $firstval; ?>,<?php echo $eventtype?>)" type="button" id="<?php echo $postid; ?>" class="eventpost-<?php echo $result->id;?> comment-post comment-post post-btn btn  blue center">Buzz</button>

			
 <button   style="display:none;" onclick="commentpollalllevels(<?php echo $parentid; ?>,<?php echo $result->id; ?>,<?php echo $firstval; ?>,<?php echo $eventtype?>)" type="button" id="<?php echo $postid; ?>" class="pollpost-<?php echo $result->id;?> comment-post comment-post post-btn btn  blue center">Buzz</button>
			
			  <button    style="display:none;" onclick="commentintradayalllevels(<?php echo $parentid; ?>,<?php echo $result->id; ?>,<?php echo $firstval; ?>,<?php echo $eventtype?>)" type="button" id="<?php echo $postid; ?>" class="intrapost-<?php echo $result->id;?> comment-post comment-post post-btn btn  blue center">Buzz</button>
...
running = true;
        var end = setInterval(function () {
			...
			var maintotal =$("#allmain-<?php echo $eventtype;?>-<?php echo $childid;?>").height();
			var childtotal =$(".allchild-<?php echo $eventtype;?>-<?php echo $childid;?>").height();

			var final = (maintotal-childtotal)+'px';
			$(".janeeshchild-<?php echo $eventtype;?>-<?php echo $childid;?>").css("height",final);
