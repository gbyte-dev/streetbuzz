...
<?php }else{
	if($eventtype == 1|| $eventtype == 2 || $eventtype == 3 ){ ?>
	<button  onclick="commentevent(<?php echo $postid; ?>,<?php echo $childid; ?>,<?php echo $eventtype;?>)" type="button" id="<?php echo $postid; ?>" class="eventpost comment-post comment-post post-btn btn  blue center">Buzz</button>

	<?php }elseif($eventtype=='yes'){
		$eventcss ='block';
		
	}elseif($eventtype == 4|| $eventtype == 5 || $eventtype == 6){ ?>
 <button  onclick="commentpoll(<?php echo $postid; ?>,<?php echo $childid; ?>,<?php echo $eventtype;?>)" type="button" id="<?php echo $postid; ?>" class="pollpost comment-post comment-post post-btn btn  blue center">Buzz</button>
		
	<?php }elseif($eventtype == 7|| $eventtype == 8 || $eventtype == 9 || $eventtype == 10){ ?>
	  <button   onclick="commentintraday(<?php echo $postid; ?>,<?php echo $childid; ?>,<?php echo $eventtype;?>)" type="button" id="<?php echo $postid; ?>" class="intrapost comment-post comment-post post-btn btn  blue center">Buzz</button>

		
	<?php }
?>
<button style="display:none;" onclick="comment(<?php echo $postid; ?>,<?php echo $childid; ?>,<?php echo $eventtype;?>)" type="button" id="<?php echo $postid; ?>" class="buzzpost comment-post  post-btn btn  blue center">Buzz</button>
<?php } ?>
		</div>
		 </div>
      </div>
