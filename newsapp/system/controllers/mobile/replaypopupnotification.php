   ...
   <div id="urtxt" style="padding:0" class="urtxt"><input type="text" class="form-control usertxt" class="group" id="usertxt-<?php echo $postid;  ?>" autocomplete="off"  value="" placeholder="Users" name="street_user"  /></div>
	...
	<input type="hidden" id="act" class="act" value="">
		 ...
		 <!--end event creation-->
			...
			if($eventtype == 1|| $eventtype == 2 || $eventtype == 3 ){
				$etype ='event';
			}elseif($eventtype == 7|| $eventtype == 8 || $eventtype == 9 || $eventtype == 10){
				$etype ='buzz';
				
			}elseif($eventtype == 4 || $eventtype == 5 || $eventtype == 6 ){
				$etype ='poll';
	
            }
			?>
	<input type="text" id="action" class="action" value='<?php echo $etype; ?>'>
...
<?php }else{ ?>
 ...
 <?php } if($eventtype == 1 || $eventtype == 2 || $eventtype == 3  ){ ?>
 			<button  style="display:<?php $eventcss; ?>;" onclick="commentevent(<?php echo $postid; ?>,<?php echo $postid; ?>,<?php echo $eventtype;?>)" type="button" id="<?php echo $postid; ?>" class="eventpost comment-post comment-post post-btn btn  blue center">Buzz</button>
...
if($eventtype == 4 || $eventtype == 5 || $eventtype == 6 ){ ?>
 <button  style="display:<?php echo $pollcss;?>;" onclick="commentpoll(<?php echo $postid; ?>,<?php echo $postid; ?>,<?php echo $eventtype;?>)" type="button" id="<?php echo $postid; ?>" class="pollpost comment-post comment-post post-btn btn  blue center">Buzz</button>
...
if($eventtype == 7 || $eventtype == 8 || $eventtype == 9 || $eventtype == 10){ ?>
  <button   onclick="commentintraday(<?php echo $postid; ?>,<?php echo $postid; ?>,<?php echo $eventtype;?>)" type="button" id="<?php echo $postid; ?>" class="intrapost comment-post comment-post post-btn btn  blue center">Buzz</button>
