...
class Base_Api_Controller extends REST_Controller {
    ...
    public $num_followers = 0;
    public $num_favourites = 0;
    ...
    public function __construct() {
        ...
        $this->return['data'] = (object)$this->return['data'];
        $this->return['error'] = (object)$this->return['error'];
    ...
    protected function _prepare_basic_auth($auth_token = FALSE) {
        ...
        if (!empty($auth_user_detail)) {
            ...
            $this->num_followers = $auth_user_detail['num_followers'];
            $this->num_favourites = $auth_user_detail['num_favourites'];
            return TRUE;
        } else {
