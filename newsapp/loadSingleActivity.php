		...
		if( !empty($buff->post_user->username) ){
		 $is_reshared    =$buff->is_post_reshared($buff->post_id);
			...
			if( preg_match( "#iPhone#i", $_SERVER['HTTP_USER_AGENT'] )  || preg_match( "#iPod#i", $_SERVER['HTTP_USER_AGENT'] ) || preg_match( "#Android#i", $_SERVER['HTTP_USER_AGENT'] ) || preg_match( "#Phone#i", $_SERVER['HTTP_USER_AGENT'] )) {
			 ...
			 if(!$user->is_logged ){
							 $whats .='<li><a href="http://www.facebook.com/sharer.php?u='.urlencode($buff->permalink).'&t='.urlencode(htmlspecialchars($user->info->username.': '.$buff->post_message)).'"  target="_blank" >Facebook</a></li>';	    
...
-->
              '.$commentstr.'
				...
				<span class="reshare-list  icon-ftr">'.$reshare_content.''.$resharecnt.'</span>
					<div class="agree-list icon-ftr f2"><a href="" data-role="services" data-namespace="activities"  >'.($post_view_cnt? '<img  width="" src="'.$C->SITE_URL.'static/images/icons/view.png"  title="View"/>' : '<img width="" src="'.$C->SITE_URL.'static/images/icons/view.png"  title="View"/>').'</a>'.($posttviewbtn_btn).'</div>
				';
				$markcnt ='<div class="like-list icon-ftr">'.$mark_content.'</div>';	
							}else{ 
					$footercnt ='<span class="reply icon-ftr icon-ftr-reply"><a href="'.$C->SITE_URL.'home"><img class="icons" src="'.$C->SITE_URL.'static/images/icons/REPLY.png" title="Reply"/></a></span> <div class="like-list icon-ftr">
					
					<a href="'.$C->SITE_URL.'home"> : <img class="icons" src="'.$C->SITE_URL.'static/images/icons/LIKE.png"  title="Like"/>'.'</a>
					
					</div>
		<div class="agree-list icon-ftr f2"><a href="" data-role="services" data-namespace="activities"  >'.($post_view_cnt? '<img  width="" src="'.$C->SITE_URL.'static/images/icons/view.png"  title="View"/>' : '<img width="" class="icons" src="'.$C->SITE_URL.'static/images/icons/view.png"  title="View"/>').'</a>'.($posttviewbtn_btn).'</div>
			...
			$tpl->layout->block->setVar('comment_footer','
               ...
               <div class="activity-footer meta-info col-lg-12 col-md-12 col-sm-12 col-xs-12 footer-layout">
...
<div class="dropdown share  icon-ftr" >
							   ...
							   <ul class="menu-options" id="'.$buff->post_id.'"  data_id1="'.$buff->post_id.'">
							     '.$whats.'
							       '.$fsfs.'
								  <li><a  data_id="'.$buff->post_id.'" href="http://www.linkedin.com/shareArticle?mini=true&url='.urlencode($buff->permalink).'&title='.urlencode(htmlspecialchars($buff->post_message)).'&source='.urlencode($buff->permalink).'&summary='.urlencode($buff->permalink).'"  target="_blank" >Linkedin</a></li>
		 ...
		 if(!empty($posttypeRes) && $posttypeRes->posttype == 2){
		        ...
		        $officalsourcetype = $checkadexist->ads_access_source;
		           if(!empty($officalsourcetype) && $officalsourcetype == 1 && $is_mobile == 1 && $checkadexist->whatsapp_number != '' ){
		            ...
		            $newstr   ="\n <a class='adslink'  href='".$display_url."' target='_blank'><img width=100%' src='".$sortimage."'></a> \n".$adsadvancehtml;
		            ...
		            $longnewstr   ="\n <a class='adslink'  href='".$display_url."'><img width=100%' src='".$sortimage."'
		            ></a> \n";
		           }else if($officalsourcetype == 3 && $checkadexist->display_url != ''){
		               /* URL Click */
		                $display_url =$checkadexist->display_url;
		             $longnewstr   ="<a class='adslink'  href='".$display_url."'><img width=100%' src='".$sortimage."'></a>";
		           }else{
		               $longnewstr   ="\n <a class='adslink lightbox-image image-thumb cboxElement' href='".$bigimage."'  target='_blank'><img width=100%' src='".$sortimage."'></a> \n";
		        ...
		        $para1sourcetype = $para1data->ads_access_source;
		           if(!empty($para1sourcetype) && $para1sourcetype == 1 && $is_mobile == 1 && $para1data->whatsapp_number != '' ){
		               ...
		               if(strpos( $para1data->whatsapp_number,"+91") !== false){
                         ...
                         $paraads = "<a class='adslink'  href='".$display_url."' target='_blank'><img width=100%' src='".$parasortimage."'></a>";
		              ...
		              $paraads   = " <a class='adslink'  href='".$display_url."'><img width=100%' src='".$parasortimage."'></a>";
		               ...
		               $paraads   ="<a class='adslink lightbox-image image-thumb cboxElement'  href='".$parasortimage."' target='_blank'><img width=100%' src='".$parasortimage."'></a>";
		           ...
		           $finalstr .=$paraads;
                     ...
                     if(!empty($checkparagaphexist2))
                     {
		               ...
		               if(strpos( $para2data->whatsapp_number,"+91") !== false){
                         ...
                         $paraads1 = "\n<a class='adslink'  href='".$display_url."' target='_blank'><img width=100%' src='".$parasortimage1."'></a>\n".$adsadvancehtml;
		              ...
		              $paraads1   = "<a class='adslink'  href='".$display_url."'><img width=100%' src='".$parasortimage1."'></a>";
		               ...
		               /* URL Click */
		                ...
		                $paraads1   ="<a class='adslink'  href='".$display_url."'><img width=100%' src='".$parasortimage1."'></a> ".$knowmorehtml;
		           }else{
		               $paraads1   ="<a class='adslink lightbox-image image-thumb cboxElement'  href='".$parasortimage1."' target='_blank'><img width=100%' src='".$parasortimage1."'></a>";
                  ...
                  $para3data = $checkparagaphexist3;
		           ...
		           if(!empty($para3sourcetype) && $para3sourcetype == 1 && $is_mobile == 1 && $para3data->whatsapp_number != '' ){
		               ...
		               if(strpos( $para3data->whatsapp_number,"+91") !== false){
                         ...
                         $paraads3 = "<a class='adslink'  href='".$display_url."' target='_blank'><img width=100%' src='".$parasortimage3."'></a>";
		              ...
		              $paraads3   = "<a class='adslink'  href='".$display_url."'><img width=100%' src='".$parasortimage3."'></a>";
		               ...
		               $paraads3   ="<a class='adslink lightbox-image image-thumb cboxElement'  href='".$parasortimage3."' target='_blank'><img width=100%' src='".$parasortimage3."'></a>";
		        ...
		        $para1sourcetype = $para1data->ads_access_source;
		           if(!empty($para1sourcetype) && $para1sourcetype == 1 && $is_mobile == 1 && $para1data->whatsapp_number != '' ){
		               ...
		               if(strpos( $para1data->whatsapp_number,"+91") !== false){
    		              ...
    		              $adsadvancehtml	    =$buff->whatsuphtml($para1data->whatsapp_number,$para1data->id,$buff->post_id);
                         $paraads = "\n<a class='adslink'  href='".$display_url."' target='_blank'><img width=100%' src='".$parasortimage."'></a>\n".$adsadvancehtml;
		                ...
		                if(strpos( $para1data->callnow_number,"+91") !== false){
    		              ...
    		              $adsadvancehtml	    =$buff->dialphonehtml($para1data->callnow_number,$para1data->id,$buff->post_id);
    		              $display_url ="tel:".$para1data->callnow_number;
		              $paraads   = "\n <a class='adslink'  href='".$display_url."'><img width=100%' src='".$parasortimage."'></a> \n".$adsadvancehtml;
		           }else if($para1sourcetype == 3 && $para1data->display_url != ''){
		               /* URL Click */
		                $display_url =$para1data->display_url;
		                 $knowmorehtml	    =$buff->knowmorehtml($display_url,$para1data->id,$buff->post_id);
		                $paraads   ="\n <a class='adslink' target='_blank'  href='".$display_url."'><img width=100%' src='".$parasortimage."'></a> \n".$knowmorehtml;
		           }else{
		               $paraads   ="\n <a class='adslink lightbox-image image-thumb cboxElement'  href='".$parasortimage."' target='_blank'><img width=100%' src='".$parasortimage."'></a> \n";
		               ...
		               if(strpos( $para2data->whatsapp_number,"+91") !== false){
		                ...
		                if(strpos( $para2data->callnow_number,"+91") !== false){
    		              ...
    		              $adsadvancehtml	    =$buff->dialphonehtml($para2data->callnow_number,$para2data->id,$buff->post_id);
    		              $display_url ="tel:".$para2data->callnow_number;
		              $paraads1   = "\n <a class='adslink'  href='".$display_url."'><img width=100%' src='".$parasortimage1."'></a> \n".$adsadvancehtml;
		           }else if($para2sourcetype == 3 && $para2data->display_url != ''){
		               /* URL Click */
		                $display_url =$para2data->display_url;
		                 $knowmorehtml	    =$buff->knowmorehtml($display_url,$para2data->id,$buff->post_id);
		               ...
		               $paraads1   ="\n <a class='adslink lightbox-image image-thumb cboxElement'  href='".$parasortimage1."' target='_blank'><img width=100%' src='".$parasortimage1."'></a> \n";
		           ...
		           if(!empty($para3sourcetype) && $para3sourcetype == 1 && $is_mobile == 1 && $para3data->whatsapp_number != '' ){
		               ...
		               if(strpos( $para3data->whatsapp_number,"+91") !== false){
    		              ...
    		              $adsadvancehtml	    =$buff->whatsuphtml($para3data->whatsapp_number,$para3data->id,$buff->post_id);
                         $paraads3 = "\n<a class='adslink'  href='".$display_url."' target='_blank'><img width=100%' src='".$parasortimage3."'></a>\n".$adsadvancehtml;
                       }else if($para3sourcetype == 2 && $is_mobile == 1 && $para3data->callnow_number !='' ){
		                /* call now in mobile*/
		                if(strpos( $para3data->callnow_number,"+91") !== false){
    		              }else{
    		              ...
    		              $adsadvancehtml	    =$buff->dialphonehtml($para3data->callnow_number,$para3data->id,$buff->post_id);
    		              $display_url ="tel:".$para3data->callnow_number;
		              $paraads3   = "\n <a class='adslink'  href='".$display_url."'><img width=100%' src='".$parasortimage3."'></a> \n".$adsadvancehtml;
		           }else if($para3sourcetype == 3 && $para3data->display_url != ''){
		               /* URL Click */
		                $display_url =$para3data->display_url;
		                 $knowmorehtml	    =$buff->knowmorehtml($display_url,$para3data->id,$buff->post_id);
		               ...
		               $paraads3   ="\n <a class='adslink lightbox-image image-thumb cboxElement'  href='".$parasortimage3."' target='_blank'><img width=100%' src='".$parasortimage3."'></a> \n";
		           ...
		           if(!empty($para4sourcetype) && $para4sourcetype == 1 && $is_mobile == 1 && $para4data->whatsapp_number != '' ){
		              ...
		              $paraads4   = "\n <a class='adslink'  href='".$display_url."'><img width=100%' src='".$parasortimage4."'></a> \n".$adsadvancehtml;
		               ...
		               $paraads4   ="\n <a class='adslink lightbox-image image-thumb cboxElement'  href='".$parasortimage4."' target='_blank'><img width=100%' src='".$parasortimage4."'></a> \n";
		           ...
		           if(!empty($para5sourcetype) && $para5sourcetype == 1 && $is_mobile == 1 && $para5data->whatsapp_number != '' ){
		               ...
		               if(strpos( $para5data->whatsapp_number,"+91") !== false){
    		              ...
    		              $adsadvancehtml	    =$buff->whatsuphtml($para4data->whatsapp_number,$para4data->id,$buff->post_id);
                         $paraads5 = "\n<a class='adslink'  href='".$display_url."' target='_blank'><img width=100%' src='".$parasortimage5."'></a>\n".$adsadvancehtml;
		              ...
		              $paraads5   = "\n <a class='adslink'  href='".$display_url."'><img width=100%' src='".$parasortimage5."'></a> \n".$adsadvancehtml;
		               ...
		               $paraads5   ="\n <a class='adslink lightbox-image image-thumb cboxElement'  href='".$parasortimage5."' target='_blank'><img width=100%' src='".$parasortimage5."'></a> \n";
		           ...
		           if(!empty($officalsourcetype) && $officalsourcetype == 1 && $is_mobile == 1 && $checkadexist->whatsapp_number != '' ){
		            ...
		            $newstr   =$firstLine."\n <a class='adslink'  href='".$display_url."' target='_blank'><img width=100%' src='".$sortimage."'></a> \n".$adsadvancehtml;
		                ...
		                if(strpos( $checkadexist->callnow_number,"+91") !== false){
    		               ...
    		               $adsadvancehtml	    =$buff->dialphonehtml($checkadexist->callnow_number,$checkadexist->id,$buff->post_id);
    		              $display_url ="tel:".$checkadexist->callnow_number;
		            $newstr   =$firstLine."\n <a class='adslink'  href='".$display_url."'><img width=100%' src='".$sortimage."'></a> \n".$adsadvancehtml;
		           }else if($officalsourcetype == 3 && $checkadexist->display_url != ''){
		               /* URL Click */
		                $display_url =$checkadexist->display_url;
		            $newstr   =$firstLine."\n <a class='adslink'  href='".$display_url."'><img width=100%' src='".$sortimage."'></a> \n".$display_url;
			...
			//Like content
			   ...
			   $grp = 'in <a href="'.$C->SITE_URL.$groups->groupname.'">'.$groups->title.'</a>' ;
				...
				if($buzztype =="buzz" || $buzztype =="" ){
					...
					$mes ="<pre>".$buff->parsetext($chield[$m]->message)."</pre>";
...
-->				
               	<span class="reshare-list icon-ftr">'.$reshare_content.''.$resharecnt.'</span>
               	 <div class="agree-list icon-ftr f4"><a href="" data-role="services" data-namespace="activities"  >'.($post_view_cnt? '<img  width="" src="'.$C->SITE_URL.'static/images/icons/view.png"  title="View"/>' : '<img width=""  src="'.$C->SITE_URL.'static/images/icons/view.png"  title="View"/>').'</a>'.$network->format_num($posttviewbtn_btn).'</div>
               	';
...
<span class="reply icon-ftr icon-ftr-reply">
				...
				<div class="like-list icon-ftr"><a href="" data-role="services" data-namespace="activities" data-action="'.($is_likedreplay? 'unlike' : 'like').'" data-value="'.htmlentities('{"activities_type":"public","activities_id":"'.$chield[$m]->id.'"}').'">'.($is_likedreplay? '<img  src="'.$C->SITE_URL.'static/images/icons/LIKE.png"  title="Like"/>' : '<img class="icons" src="'.$C->SITE_URL.'static/images/icons/LIKE.png"  title="Like"/>').'</a>'.$showlikes_btn.'</div>
                <div class="agree-list icon-ftr f4"><a href="" data-role="services" data-namespace="activities"  >'.($post_view_cnt? '<img  width="" src="'.$C->SITE_URL.'static/images/icons/view.png"  title="View"/>' : '<img width="" class="icons" src="'.$C->SITE_URL.'static/images/icons/view.png"  title="View"/>').'</a>'.$network->format_num($posttviewbtn_btn).'</div>
...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 buzz-parent-box replay'.$buff->post_id.' single'.$chield[$m]->id.'"  style="border:0px solid red;" id="'.$chi.'">
 ...
 <div class="col-md-1 col-lg-1 col-sm-1 col-xs-2 image-div" style="padding:0; overflow:hidden"><a href="'.userlink($chield[$m]->username).'" class="avatar bizcard" data-userid="'.$chield[$m]->userid.'">'.$img.'</a>
            </div>
...
$imagedes .= '<a  target="_blank" href="'.($C->STORAGE_URL.'tmp/'.$tmp->file_preview).'" class="lightbox-image image-thumb cboxElement'.$post_id.' "><img width="100%" alt="Image" src="'.$C->STORAGE_URL.'tmp/'.($tmp->file_preview).'" /></a>';
		...
		if( count( $buff->post_attached ) > 0 ){ 
			...
			if( isset($buff->post_attached['file']) ){
				foreach($buff->post_attached['file'] as $k => $file){
					...
					$tpl->layout->inner_block->setVar('activity_attachments_files', ' <video  id="video'.$buff->post_id.'" controls width="100%" >
  <source src="'.$fileor.'" type="video/mp4">
</video>
');
...
$data=$tpl->layout->inner_block->setVar('activity_attachment_images_preview', '<a target="_blank" href="'.($C->STORAGE_URL.'attachments/'.$network->id.'/'.$image->file_preview).'" class="lightbox-image image-thumb cboxElement"><img alt="Image" src="'.$C->STORAGE_URL.'attachments/'.$network->id.'/'.($image->file_preview).'" /></a>');
   ...
   $tpl->layout->inner_block->setVar('activity_attachment_images',$data);
		...
		$data.='
<button class="w3-button w3-black w3-display-left" onclick="plusDivstime'.$buff->post_id.'(-1)">&#10094;</button>
  <button class="w3-button w3-black w3-display-right" onclick="plusDivstime'.$buff->post_id.'(1)">&#10095;</button>
</div>

<script>
var slideIndex = 1;
showDivstime'.$buff->post_id.'(slideIndex);

function plusDivstime'.$buff->post_id.'(n) {
  showDivstime'.$buff->post_id.'(slideIndex += n);
}

function showDivstime'.$buff->post_id.'(n) {
  var i;
  var x = document.getElementsByClassName("mySlides'.$buff->post_id.'");
