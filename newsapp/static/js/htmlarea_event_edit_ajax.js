...
var grouptxt = function () {
    ...
    function stopAC() {
        ...
        $('#grouptxtedit').unbind('keydown.ac');
    ...
    function highlighter(el) {
        ...
        if ($(el).parents('#grouptxtedit').length > 0) {
            $(el).parents('#grouptxtedit').find('.textarea-highlighter').html(cnt);
        } else {
