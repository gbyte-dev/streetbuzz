<div class="comments-thread-container" data-value="{%comments_thread_id%}">
	...
	<!-- <div class="comments-editor-field"><a href="#" data-action="activityAddComment" data-namespace="comments" data-role="services"><?= $this->page->lang('activity_comment_option_comment_write') ?></div>  -->
...
<textarea class="htmlarea" id="comment-editor" data-placeholder="<?= $this->page->lang('activity_comment_option_comment_write') ?>"><?= $this->page->lang('activity_comment_option_comment_write') ?></textarea>
			<div class="buttons">
