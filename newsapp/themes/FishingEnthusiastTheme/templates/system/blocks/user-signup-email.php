...
<form action="" method="POST">
	...
	<input type="text" value="{%user_signup_email_value%}" name="email" id="email" class="form-control" data-status="focus"/>
	<div class="clear"></div>
	...
	<div class="captcha-fields">
		<input type="text" id="captcha_word" class="form-control" name="captcha_word" {%autofocus%} />
	...
	<div class="registration-buttons">
		<button type="submit" value="submit" name="submit" class="btn btn-lg btn-primary"><span><?= $this->page->lang('signup_step1_form_submit') ?></span></button>
		<div class="clear"></div>
	</div>
</form>
