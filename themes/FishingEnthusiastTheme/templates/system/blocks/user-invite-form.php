<form action="" method="POST">
	...
	<div class="invite-users-header">
		<h3 class="title"><?= $this->page->lang('group_invite_people') ?></h3>
		<?php /*
	...
	<button name="submit_invite_members" type="submit" class="btn blue"><span><?= $this->page->lang('group_invite_people_sbm_btn') ?></span></button>
</form>