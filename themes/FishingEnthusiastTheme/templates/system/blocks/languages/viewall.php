			...
			<tr>
				...
				<td>
					<? if($lang['installed'] == false):?>
						<a href="<?=$C->SITE_URL;?>admin/languages/tab:installLangpack/langkey:<?=$lang['langkey'];?>" class="btn btn-success">
							<span>Install</span>
						</a>
					<? else: ?>
						<? if ( $lang['upgradable'] == true): ?>
							<a href="<?=$C->SITE_URL;?>admin/languages/tab:updateLangpack/langkey:<?=$lang['langkey'];?>" class="btn blue btn-info">
								<span>Upgrade</span>
							</a>
						<? endif; ?>
						<a href="<?=$C->SITE_URL;?>admin/languages/tab:uninstallLangpack/langkey:<?=$lang['langkey'];?>" class="btn btn-warning">
							<span>Uninstall</span>
						</a>
					<? endif; ?>
				</td>
